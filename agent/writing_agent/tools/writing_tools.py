...
def check_references(
    ...
    """
    from writing_agent.tools.reference_check import check_text, urllib_fetcher
...
def _check_edit_granularity(group) -> str:
    ...
    from writing_agent.domain.edit_groups import EditGroup
    coarse: list[str] = []
...
def propose_edits(
    ...
    from writing_agent.domain.edit_groups import EditValidationError
...
def remember_context(
    ...
    """
    from writing_agent.domain.memory_store import KIND_KNOWLEDGE, SCOPE_DOCUMENT, SCOPE_GLOBAL, MemoryEntry
...
def get_enabled_writing_tools() -> list:
    ...
    from writing_agent.runtime.tool_manager import get_enabled_tool_ids
